...
entry:
  ...
  %y = load i8, i8* %4
  %z30 = alloca %Nat
  %5 = getelementptr %Nat, %Nat* %z30, i32 0, i32 0
  store i1 false, i1* %5
  %z31 = alloca %Nat
  %6 = getelementptr %Nat, %Nat* %z31, i32 0, i32 0
  store i1 true, i1* %6
  %7 = bitcast %Nat* %z30 to i64*
  %8 = getelementptr %Nat, %Nat* %z31, i32 0, i32 1
  store i64* %7, i64** %8
  %z = alloca %Nat
  %9 = getelementptr %Nat, %Nat* %z, i32 0, i32 0
  store i1 true, i1* %9
  %10 = bitcast %Nat* %z31 to i64*
...
case.1.ret:                                       ; preds = %entry
  ...
  %_u24 = load double, double* %18
  %19 = call i64 @f(double %_u24, i8 %y)
  br label %case.end.ret
...
case.1.ret:                                       ; preds = %entry
  %_u27 = bitcast i64* %3 to %Nat*
  %res32 = call i64 @countNat(%Nat* %_u27)
  %6 = add i64 1, %res32
  br label %case.end.ret
