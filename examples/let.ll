...
case.0.x:                                         ; preds = %entry, %entry
  %x15 = call i64 @f(i64 100)
  %0 = call i64 @abs(i64 %x15)
  br label %case.end.x

case.1.x:                                         ; preds = %entry
  %x16 = call i64 @threeHundred()
  %x17 = call i64 @f(i64 %x16)
  %1 = call i64 @abs(i64 %x17)
  br label %case.end.x
...
case.1.ret:                                       ; preds = %entry
  %res18 = call i64 @threeHundred()
  %1 = alloca i64
  store i64 %res18, i64* %1
  %2 = load i64, i64* %1
  br label %case.end.ret
