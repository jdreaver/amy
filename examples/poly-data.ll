...
entry:
  %res71 = call %Either* @f()
  %0 = getelementptr %Either, %Either* %res71, i32 0, i32 0
  %1 = load i1, i1* %0
  %2 = getelementptr %Either, %Either* %res71, i32 0, i32 1
  %3 = load i64*, i64** %2
...
case.1.ret:                                       ; preds = %entry
  %_u65 = load i64, i64* %3
  %res72 = call %Either* @h()
  %6 = getelementptr %Either, %Either* %res72, i32 0, i32 0
  %7 = load i1, i1* %6
  %8 = getelementptr %Either, %Either* %res72, i32 0, i32 1
  %9 = load i64*, i64** %8
...
case.0.6:                                         ; preds = %case.1.ret, %case.1.ret
  %_u60 = load i64, i64* %9
  %10 = alloca i64
  store i64 %_u60, i64* %10
  %11 = load i64, i64* %10
  br label %case.end.6

case.1.6:                                         ; preds = %case.1.ret
  %_u61 = bitcast i64* %9 to %Either*
  %12 = getelementptr %Either, %Either* %_u61, i32 0, i32 0
  %13 = load i1, i1* %12
  %14 = getelementptr %Either, %Either* %_u61, i32 0, i32 1
  %15 = load i64*, i64** %14
...
case.0.13:                                        ; preds = %case.1.6, %case.1.6
  %_u62 = load i64, i64* %15
  %16 = alloca i64
  store i64 %_u62, i64* %16
  %17 = load i64, i64* %16
...
entry:
  %res73 = alloca %Either
  %0 = getelementptr %Either, %Either* %res73, i32 0, i32 0
  store i1 false, i1* %0
  %1 = alloca i64
  store i64 42, i64* %1
  %2 = getelementptr %Either, %Either* %res73, i32 0, i32 1
  store i64* %1, i64** %2
  %3 = getelementptr %Either, %Either* %res73, i32 0, i32 0
  %4 = load i1, i1* %3
  %5 = getelementptr %Either, %Either* %res73, i32 0, i32 1
  %6 = load i64*, i64** %5
