...
data CPSFixBinding
  = CPSFixBinding
  { cpsFixBindingName :: !Name
  , cpsFixBindingArgs :: ![Name]
...
freeCPSFixVariables :: CPSFix -> Set Name
...
freeCPSValVariables :: CPSVal -> Set Name
